    ...
    html: |
      <div class="animated-terminal" aria-label="devmux CLI demo terminal">
        ...
        <div class="terminal-body">
          ...
          <span class="line dim">Checking devmux-myapp-api...</span>
          ...
          <span class="line ok">api        running   8787    devmux-myapp-api</span>
          <span class="line ok">web        running   3000    devmux-myapp-web</span>
          <span class="line">&nbsp;</span>
...
<CardGrid stagger>
  <Card title="Shared Awareness" icon="approve-check">
    Both humans and AI agents use the same tmux session naming convention (`devmux-{project}-{service}`). One starts a server, the other reuses it.
  </Card>
...
devmux ensure api
# -> Creates tmux session: devmux-myproject-api

# Later, AI agent needs the API
devmux ensure api  
# -> Sees devmux-myproject-api already running
# -> Reuses it (no restart!)

# Check what's running
devmux status
# Service    Status    Port    Session
# api        running   8787    devmux-myproject-api
```
