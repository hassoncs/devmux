...
import { checkHealth, checkPort } from "../health/checkers.js";
...
describe("checkHealth", () => {
	it("supports explicit none health checks as tmux-pane checks", async () => {
		expect(await checkHealth({ type: "none" }, "__devmux_missing_session__")).toBe(false);
	});
});
