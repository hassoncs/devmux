...
```json
{
  ...
  "expectStatus": 200  // optional — by default, any status < 500 is healthy
}
```
...
Default: `devmux-{project}-{service}`
...
2. Check tmux session: `tmux attach -t devmux-myapp-api`
